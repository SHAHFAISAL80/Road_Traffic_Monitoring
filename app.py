...
model = YOLO(r'C:\Users\x\Videos\traffic\yolov8n.pt')

video = cv2.VideoCapture(r'C:\Users\x\Videos\traffic\traffic.mp4')
...
up_img = cv2.imread(r'C:\Users\x\Videos\traffic\up.png', cv2.IMREAD_UNCHANGED)
up_img = cv2.resize(up_img, (50, 50))
down_img = cv2.imread(r'C:\Users\x\Videos\traffic\down.png', cv2.IMREAD_UNCHANGED)
...
while True:
    ...
    cvzone.putTextRect(frame, f'At Left : {vehicle_count["left"]}', (50, 50), 2, 2, offset=20, border=2, colorR=(127, 0, 255), colorB=(127, 0, 255))
    cvzone.putTextRect(frame, f'At Middle : {vehicle_count["middle"]}', (500, 50), 2, 2, offset=20, border=2, colorR=(127, 0, 255), colorB=(127, 0, 255))
    cvzone.putTextRect(frame, f'At Right : {vehicle_count["right"]}', (1000, 50), 2, 2, offset=20, border=2, colorR=(127, 0, 255), colorB=(127, 0, 255))
